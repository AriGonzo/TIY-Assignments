...
// console.log(num)
//
// function wordsToNum(wordA, wordB){
//   CODE CODE CODE
//   return stuff
// }
...
var stringCalc = {
  wordsToNum : function(wordA, wordB){
    return num["zero"] + num["five"];
  }
}

console.log(stringCalc.wordsToNum("zero", "five"))


var assert = require('chai').assert;

describe("wordsToNum(), will convert two written numbers to numerals and return        the sum", function(){
