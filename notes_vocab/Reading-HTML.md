...
* example: <h1 class="title">
                                  <a href="http://orlando.theironyard.com/post/100189034319/matt-wallaert-behavioral-scientist-bing-will-be">Matt Wallaert, Behavioral Scientist @ Bing, Will be Here Tomorrow!</a></h1>
  * URL: http://orlando.theironyard.com/
...
* example: <ul><li><span>What did you do yesterday?</span></li>
...
* example: <table class="tabint8" style="border: 1px solid #e7e7e7;">
<tbody><tr>
</tbody></table>
  * URL: http://www.science.co.il/PTelements.asp
* example: <table class="infobox" cellspacing="3" style="border-spacing:3px;width:22em;width: 24em; background: #f2f9ff;;">
    <tbody><tr>
    <th colspan="2" style="text-align:center;font-size:125%;font-weight:bold;background: #99c2ff;;">Batman</th>
    </tr>
    <tr
    </tr>
    </tbody></table>
...
* example: <tr>
  ...
  * URL: https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table
* example: <tr>
		<td style="font-weight:bold;">24/7/13</td><td style="font-weight:bold;">8 of 13</td><td style="font-weight:bold;">6.2</td><td style="font-weight:bold;">
	</tr>
